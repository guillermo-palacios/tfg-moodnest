...
export default function PublicLayout({ children }) {
  return (
    <div className="flex min-h-screen flex-col bg-canvas text-main transition-colors duration-300">
      ...
      {/* NAVBAR PÚBLICA: Estilo corporativo responsivo */}
      <nav className="sticky top-0 z-50 flex flex-col items-center gap-4 bg-primary px-6 py-4 shadow-md transition-colors duration-300 sm:flex-row sm:justify-between sm:gap-0">
        ...
        <div className="flex items-center space-x-4">
          <Link to="/login" className="font-medium text-white/90 transition-colors hover:text-white">
            Iniciar Sesión
          </Link>
      ...
      {/* FOOTER PÚBLICO */}
      <footer className="mt-auto border-t border-gray-200 bg-surface py-6 text-center text-sm text-main/50 transition-colors duration-300 dark:border-gray-800">
