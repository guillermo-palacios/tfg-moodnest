 ...
 * Proporciona una visión general de la propuesta de valor de MoodNest y el call-to-action de registro.
 */
  ...
  return (
    <div className="flex flex-col items-center text-center max-w-3xl py-10">
      ...
      <p className="mb-10 text-lg text-main/70 md:text-xl max-w-2xl">
        MoodNest te ayuda a registrar tu estado de ánimo diario, descubrir qué actividades 
        te hacen sentir mejor y visualizar tu progreso a lo largo del tiempo.
      </p>
