\chapter{Análisis y Especificación del Sistema}
...
\subsection{Módulo 1: Gestión de Usuarios}
...
\subsection{Módulo 2: Registro Diario y Etiquetas}
...
\subsection{Módulo 3: Panel Principal e Historial}
...
\subsection{Módulo 4: Análisis de Datos (Estadísticas)}
...
\subsection{Módulo 5: Personalización y Sistema}
...
\subsection{Bloque 1: Compatibilidad y Portabilidad}
...
\subsection{Bloque 2: Rendimiento y Disponibilidad}
...
\subsection{Bloque 3: Usabilidad e Interfaz}
...
\reqTable{Usabilidad e Interfaz}{
    ...
    RNF3.2 & El sistema minimizará la fricción, permitiendo al usuario acceder a la pantalla de creación de un nuevo registro en un máximo de dos interacciones desde que inicia sesión. \\ \hline
...
\subsection{Bloque 4: Seguridad y Privacidad}
...
\section{Requisitos de Información (RI)}
...
\subsection{RI-01: Información del Usuario}
...
\subsection{RI-02: Información de la Etiqueta}
...
\subsection{RI-03: Información del Registro Diario}
