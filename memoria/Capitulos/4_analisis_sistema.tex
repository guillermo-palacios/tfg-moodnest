...
% --- CONFIGURACIÓN DE TABLAS MAESTRAS (Asegúrate de tener xltabular y colortbl en el preámbulo) ---
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        ...
        \item El sistema redirige a la pantalla de inicio de sesión mostrando un mensaje de éxito.
    \end{enumerate} 
    \\ \hline
    Flujo Alternativo & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario accede a la sección de ''Configuración de Perfil''.
        \item El sistema recupera y muestra el nombre de visualización actual del usuario.
    ...
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        ...
        \item \textbf{Cancelar}: El usuario decide no guardar los cambios y pulsa en ''Volver'' o ''Cancelar''. El sistema regresa a la vista anterior sin realizar ninguna modificación en la base de datos.
    \end{enumerate}
    \\ \hline
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario selecciona la opción ''Cerrar Sesión'' ubicada en el menú principal o el perfil.
        \item El sistema muestra un cuadro de diálogo emergente solicitando la confirmación de la acción.
        ...
        \item El sistema redirige al usuario a la pantalla pública de inicio.
    \end{enumerate} 
    \\ \hline
    Flujo Alternativo & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item \textbf{Cancelar Cierre}: En el paso 2, el usuario selecciona ''Cancelar'' o hace clic fuera del cuadro de diálogo. El sistema oculta el aviso y la sesión activa se mantiene intacta.
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        ...
        \item El sistema revoca el token de sesión actual.
        \item El sistema redirige al usuario a la página de inicio pública mostrando un mensaje de confirmación de baja.
    \end{enumerate} 
    \\ \hline
    Flujo Alternativo & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario selecciona la opción ''Nuevo Registro'' desde el panel principal.
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario selecciona un registro específico desde el historial o el panel principal.
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario accede a su catálogo de etiquetas y selecciona ''Crear Nueva Etiqueta''.
        ...
        \item El usuario selecciona ''Guardar''.
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        ...
        \item El sistema calcula la racha actual consultando los días consecutivos con un registro en la base de datos.
    ...
    Flujo Alternativo & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item \textbf{Usuario Sin Historial}: Si en el paso 4 y 5 el sistema detecta que el usuario no tiene ningún registro previo, el contador de racha se inicializa a 0. En la sección de entradas recientes, el sistema muestra un mensaje amigable invitando al usuario a crear su primer registro de estado de ánimo.
    \end{enumerate}
    \\ \hline
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    \rowcolor{UCO}
    \textcolor{white}{Campo} & \textcolor{white}{Descripción---------------------REVISAR} \\ \hline
    \endfirsthead
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario selecciona la opción ''Historial'' en el menú de navegación.
    ...
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        ...
        \item \textbf{Seleccionar día sin registro}: En el paso 4, si el usuario selecciona un día que no tiene registro, el sistema muestra un mensaje indicando que no hay registros.
    \end{enumerate}
    \\ \hline
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario accede a la sección de ''Análisis'' o ''Estadísticas''.
    ...
    Flujo Alternativo & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item \textbf{Cambiar Filtro Temporal}: En el paso 4, el usuario selecciona un rango diferente (Mensual o Anual). El sistema actualiza el rango de fechas, repite los pasos 3 y 4, y el caso de uso finaliza.
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario accede a la página de análisis.
...
\begin{xltabular}{\textwidth}{|>{\columncolor{gray!20}\bfseries}p{3.5cm}|X|}
    ...
    Flujo Principal & 
    \begin{enumerate}[leftmargin=0.5cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=4pt]
        \item El caso de uso comienza cuando el usuario accede a la sección de ''Impacto de Etiquetas''.
