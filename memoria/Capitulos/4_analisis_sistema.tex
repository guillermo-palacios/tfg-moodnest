...
\begin{xltabular}{\textwidth}{|c|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}X|c|}    \hline
    ...
    CU12 & Analizar Impacto de Etiquetas & El usuario selecciona etiquetas específicas para comparar su influencia en el estado de ánimo global. & Registrado \\ \hline
    CU13 & Visualizar Estadísticas Generales & El usuario accede al análisis de datos para visualizar el impacto de las etiquetas, los promedios semanales y la distribución porcentual de su ánimo. & Registrado \\ \hline    
    % --- Grupo 5 ---
