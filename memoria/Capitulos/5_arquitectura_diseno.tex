...
\begin{itemize}
    \item \colorboxsquare{MoodTerrible} \textbf{1 - 2 (Terrible):} Rojo - Estado de malestar agudo.
    \item \colorboxsquare{MoodRegular} \textbf{3 - 4 (Regular):} Naranja - Tensión o incomodidad.
    \item \colorboxsquare{MoodNormal} \textbf{MoodNormal} \textbf{5 - 6 (Normal):} Amarillo - Estado neutro.
    \item \colorboxsquare{MoodBien} \textbf{7 - 8 (Bien):} Verde Lima - Tranquilidad y bienestar.
    \item \colorboxsquare{MoodPrimario} \textbf{9 - 10 (Excelente):} Índigo Primario - Máximo bienestar y éxito emocional.
\end{itemize}
