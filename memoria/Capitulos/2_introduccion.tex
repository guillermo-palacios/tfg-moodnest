...
En la actualidad, la sociedad concede una importancia creciente al bienestar integral \cite{bib:noticia2024ipmark}, donde la salud mental ocupa un lugar tan relevante como la salud física. Nuestra vida cotidiana está cada vez más influenciada por la digitalización y un ritmo acelerado que, si bien ofrece numerosas ventajas, también puede generar estrés, ansiedad y una desconexión con nuestro estado emocional interno \cite{bib:articulo2025tecnoestres}. Este contexto ha generado nuevas oportunidades y desafíos en ámbitos como la salud digital, el desarrollo de software orientado al usuario y las ciencias del comportamiento, lo cual representa una tendencia cuya magnitud económica se puede observar en el crecimiento multimillonario del mercado global del bienestar, como ilustra la Figura \ref{fig:mercado_bienestar}.

\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{Imagenes/mercado_bienestar.png}
    \caption{Tamaño del mercado mundial de la industria del bienestar 2019-2027 (en miles de millones de dólares) \cite{statista:bienestar}.}
