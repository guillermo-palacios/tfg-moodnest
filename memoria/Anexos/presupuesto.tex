...
\begin{tabular}{ |m{7cm}|m{2cm}|m{2cm}|m{2cm}| }
 \hline
 \rowcolor{LightCyan}
 Descripción & Cantidad & \centering Precio (\euro) & Importe (\euro)\\
 \hline
\multicolumn{1}{|l|}{Pantalla LCD Quimat 20x4} & \multicolumn{1}{|c|}{1} & \multicolumn{1}{|r|}{10,69} & \multicolumn{1}{|r|}{10,69}\\
\hline
...
\hline
Placas de prototipado & 2 & 3 & 6\\
\hline
\textbf{Total} &  &  & \textbf{59,90 \euro}\\
\hline
\end{tabular}
\caption{Prespuesto del proyecto.}
